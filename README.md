...
uv run --with cryptography python tools/verify_release.py \
    Insta360-Markers-0.4.2-arm64.zip --authority release_ca.pem
```
...
```bash
pip install insta360py-0.4.2-py3-none-any.whl
```
...
```bash
uvx --from "git+https://github.com/ReignBock/insta360py@v0.4.2" insvtools --version
uvx --from "git+https://github.com/ReignBock/insta360py@v0.4.2" insv-markers --help
```
